...
def create_model(args, maxlen, vocab):
    ...
    y_s = Average()(e_w)
    att_weights = Attention(name='att_weights',  #conditioned on the embedding of the word ewi as well as the global context of the sentence
                            W_constraint=MaxNorm(10),
                            b_constraint=MaxNorm(10))([e_w, y_s])
    z_s = WeightedSum()([e_w, att_weights]) #sentence embedding==weighted summation of word embedding
    ...
    ##### Reconstruction #####
    p_t = Dense(args.aspect_size)(z_s) #z_s==weighted summation of word embedding
