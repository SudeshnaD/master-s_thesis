...
#aspect_file='/home/sdasgupta/sdasgupta_dir/Sememes_AE-SA/experiment_sentihood/GloveCode/LDA_NMF/output_dir/aspect.log'+str(args.aspect_size)+'.pkl'
#aspect_dict=0
#with open(aspect_file,'rb') as f:
#    aspect_dict=pickle.load(f)
