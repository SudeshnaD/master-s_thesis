def aspect_parse(asp_size):
    ...
    aspect_file=r'C:\Users\Sudeshna Dasgupta\Documents\Thesis_GuidedResearch\thesis\Aspect Extraction\Baseline models\KMEANS\output_dir\aspect.log'+str(asp_size)
