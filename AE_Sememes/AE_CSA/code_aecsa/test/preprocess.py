...
with open("labelled_text_out.txt", "w", newline="") as f:
    f.write(str(train_labelled))
    #writer = csv.writer(f)
    #writer.writerows(train_labelled)
with open("unlabelled_text_out.txt", "w", newline="") as f:
    f.write(str(train_unlabelled))
    #writer = csv.writer(f)
    #writer.writerows(train_unlabelled) """
