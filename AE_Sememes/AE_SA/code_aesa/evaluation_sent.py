...
test_fn = K.function([model.get_layer('sentence_input').input, model.get_layer('sentence_average').input, K.learning_phase()],
...
for batch in tqdm(test_x):
    ...
    input_sememe, input_average = sem.run_script()
    cur_att_weights, cur_aspect_probs = test_fn([input_sememe,input_average,0])
...
7: 'general', 8: 'safety', 9:'general', 10: 'touristy', 11: 'transit-location', 12: 'shopping', 13: 'general', 14: 'general', 15: 'multicultural',
16: 'touristy', 17: 'touristy', 18: 'price', 19: 'general', 20: 'nightlife', 21:'live', 22: 'general', 23: 'transit-location', 24:'general', 25: 'general', 
26: 'multicultural', 27: 'touristy', 28: 'general', 29: 'general', 30: 'general', 31: 'general', 32: 'general', 33: 'safety', 34: 'general', 35: 'touristy', 36: 'quiet',
